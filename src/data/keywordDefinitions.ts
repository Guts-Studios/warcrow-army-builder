export const keywordDefinitions: { [key: string]: string } = {
  ...
  "Ambusher": "Ambusher units wait in hiding, ready to move into action once the battle has already started, striking by surprise. If you choose, you can keep your Ambusher units secret and not deploy them until after the game has begun.\n\nActivation Rules:\nYou can activate your Ambusher unit during your turn instead of activating another unit, as if your Ambusher were already on the battlefield. When you choose to activate an Ambusher, follow these steps:\n\n1. Deploy the Unit on the Battlefield:\n   - Option 1:\n     Deploy the unit in your deployment area:\n     - You may deploy it engaged in combat with an enemy unit.\n     - It is considered to have charged, but the enemy unit cannot hold and fire.\n   - Option 2:\n     Deploy the unit anywhere on the battlefield (except your opponent's deployment zone) if:\n     - No enemy units within 10 strides have Line of Sight to it.\n\n2. Activate the Unit:\n   After deployment, the Ambusher unit can immediately activate as normal.",
